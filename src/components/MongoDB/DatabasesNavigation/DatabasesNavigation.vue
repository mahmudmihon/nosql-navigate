<template>
  ...
  <n-modal
    ...
    :bordered="true"
    size="medium"
    :on-after-leave="clearCollectionCreateModel"
  >
...
<script setup lang="ts">
  ...
  const createCollection = async (): Promise<void> => {
    ...
    try {
      await MongoDbService.createCollection(componentState.collectionAddModel.dbName, componentState.collectionAddModel.collectionName);
  ...
  const clearCollectionCreateModel = (): void => {
    componentState.collectionAddModel.dbName = '';
