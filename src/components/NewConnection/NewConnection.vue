<template>
  <div class="w-6/12 p-4 bg-base rounded-lg m-auto">
    ...
    <div class="mt-5">
        ...
        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="mongodb://localhost:27017" v-model.trim="componentState.connectionUrl">
    </div>
